...
class AD9912():
    ...
    def __init__(self):
        ...
        config.spi_writebyte([((addr_Ndiv & 0xFF00) | 0x60) >> 8, addr_Ndiv & 0x00FF])
    ...
    def setFrequency(self, f):
        ...
        config.spi_writebyte([((addr_FTW0 & 0xFF00) | 0x60) >> 8, addr_FTW0 & 0x00FF])
    ...
    def setAmp(self, amp):
        ...
        config.spi_writebyte([((addr_DAC0 & 0xFF00) | 0x60) >> 8, addr_DAC0 & 0x00FF])
